...
mat = scipy.io.loadmat('C:/Users/SB00763936/Desktop/AI-Baby/DIA AI/FullData/DIA104/full_set_S1.mat')
...
slots =[[1,115], [124,239], [299,354], [414,474], [707,757]]
# slotsname =['ranB1', 'ranB2', 'ranCR', 'ranDC']
slotsname =['B1', 'B2', 'CR1', 'CR2', 'DC']
...
for p, slot in enumerate (slots):
    for frame_num in range(slot[0], slot[1]):
        ...
        if a!=0:
            with open('C:/Users/SB00763936/Desktop/AI-Baby/DIA AI/FullData/DIA104/'+'DIA116_'+slotsname[p]+'.txt', 'a') as file:
                file.write(f'{frame}\n')
                file.close()

    with open('C:/Users/SB00763936/Desktop/AI-Baby/DIA AI/FullData/DIA104/'+'DIA116_'+slotsname[p]+'.txt','r') as file:
        filedata = file.read()
        filedata = filedata.replace(',', '').replace('[', '').replace(']', '').replace("'", '')

    with open('C:/Users/SB00763936/Desktop/AI-Baby/DIA AI/FullData/DIA104/'+'DIA116_'+slotsname[p]+'.txt', 'w') as file:
        file.write(filedata)
